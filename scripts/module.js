...
import { sendUpdateMessage } from "./animations/helpers.js";
...
Hooks.once("init", async () => {
  ...
  game.settings.register(MODULE_ID, "previous-version.message", {
    name: game.i18n.localize(
      `${MODULE_ID}.module-settings.previous-version.message.name`,
    ),
    hint: game.i18n.localize(
      `${MODULE_ID}.module-settings.previous-version.message.hint`,
    ),
    scope: "world",
    config: true,
    default: true,
  ...
  game.settings.register(MODULE_ID, "previous-version", {
    name: "",
    hint: "",
    scope: "world",
    config: true,
...
Hooks.on("ready", () => {
  ...
  if (
    game.settings.get(MODULE_ID, "previous-version.message") &&
