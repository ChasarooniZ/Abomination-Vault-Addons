...
export async function breakingTheSeal({ useSFX = true, volume = 1 }) {
  if (missingModulesError(["jb2a", "sequencer", "ggg"])) return;
  const pos = {
    altar: { x: 3525, y: 2925 },
    artifact: {
  ...
  const sfx = {
    flash: [
      "ggg-sfx.magic.arcane.buff.general.03.01",
      "ggg-sfx.magic.arcane.buff.general.03.02",
      "ggg-sfx.magic.arcane.buff.general.03.03",
      "ggg-sfx.magic.arcane.buff.general.03.04",
    ],
    aura: "ggg-sfx.magic.occult.cast.fear.02",
    beam: {
      start: "ggg-sfx.magic.occult.cast.beam.03",
      loop: [
        "ggg-sfx.magic.fire.fireball.01.medium.loop.trail",
        "ggg-sfx.magic.arcane.surge.long.03.01",
      ],
      end: "ggg-sfx.magic.earth.cast.magnetic.01.01",
    },
    barrierDrop: "ggg-sfx.magic.occult.cast.shatter.01",
  };
